    ...
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      >
        ...
        <div ref={el => { sectionRefs.current[0] = el; }} style={sectionStyle}>
          <section className="flex flex-col items-center justify-center text-center px-6 py-10 flex-1">
        ...
        <div ref={el => { sectionRefs.current[4] = el; }} style={sectionStyle}>
          ...
          <footer className="px-6 py-10 text-center flex-shrink-0" style={{ background: "#1E2614" }}>
