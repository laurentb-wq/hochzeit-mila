    ...
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
        ...
        <div className="px-6 py-10 flex-1 overflow-y-auto">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-stretch">
              {[
                { icon: "✨", title: "Wir freuen uns über", items: ["Farben statt Schwarz", "Luftige Sommeroutfits", "Festliche Leichtigkeit"] },
      ...
      <section ref={el => { sectionRefs.current[5] = el; }} style={sectionStyle}>
        ...
        <footer className="px-6 py-4 sm:py-3 mt-6 sm:mt-0 text-center flex-shrink-0 space-y-1" style={{ background: "#1E2614" }}>
          ...
          <p className="text-xs" style={{ color: "rgba(205,213,176,0.35)" }}>Mirjam Bieri und Laurent Born · Könizstrasse 43 · 3008 Bern</p>
        </footer>
      </section>
